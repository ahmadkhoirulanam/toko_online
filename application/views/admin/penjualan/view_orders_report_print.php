<?php $kota = $this->db->query("SELECT nama_kota FROM kota WHERE kota_id=$iden[kota_id]")->row_array(); ?>
<!DOCTYPE html>
<html>
  ...
  <table class="table table-responsive" style="width: 100%; text-align:left">
    ...
    <tbody>
      ...
      foreach ($record->result_array() as $row) {
        ...
        $tujuan = $this->db->query("SELECT * FROM `kota` JOIN provinsi ON kota.provinsi_id=provinsi.provinsi_id WHERE kota.kota_id=$id_kota")->row_array();
