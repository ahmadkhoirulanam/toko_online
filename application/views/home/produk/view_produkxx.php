                        ...
                        <div class="widget-filters widget widget-filters--offcanvas--mobile" data-collapse data-collapse-opened-class="filter--opened">
                            ...
                            <div class="widget-filters__list">
                                ...
                                <ul class="filter-categories__list">
                                    <?php $query = $this->db->get('kategoriproduk');
                                        ...
                                        <div class="widget-products__item">
                                            ...
                                            <div class="widget-products__info">
                                                ...
                                                <div class="widget-products__prices">
                                                     Ecer Rp <?= rupiah($row['harga_ecer']) ?> <br/>
								  Grosir  Rp <?= rupiah($row['harga_grosir']) ?> dgn Minimal Pembelian <?= $row['minimal_pembelian'] ?> <?= $row['satuan'] ?>
                                                </div>
                                            </div>
                                        </div>
                                <?php }
                        ...
                        <div class="products-list__body">
                            ...
                            foreach ($record->result_array() as $row) {
                                ...
                                if ($stok !== 0) { ?>
								  ...
								  Ecer Rp <?= rupiah($row['harga_ecer']) ?> <br/>
								  Grosir  Rp <?= rupiah($row['harga_grosir']) ?><br/> 
								  Min. Order. <?= $row['minimal_pembelian'] ?> <?= $row['satuan'] ?>
