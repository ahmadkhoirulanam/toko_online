...
<div class="wrapper w-100 mx-auto">
  ...
  <table class="table table-bordered table-sm mt-3" id='tablemodul1'>
    ...
    <tbody>
      ...
      $no = 1;
      $diskon_total = 0;
      foreach ($recordretur->result_array() as $row) {
        $video = $row['video_unboxing'];
      ...
      ?>
        ...
        <div class="form-group row">
          ...
          <div class="col-md-5"> 
              <a href="<?= base_url() ?>assets/images/bukti/<?= $video ?>" target="_blank"><?= $video ?></a> 
          </div>
        </div>

       <div class="form-group row">
          <label class="col-md-2 col-form-label">Status Retur</label>
          <div class="col-md-5"> 
              <?= $status ?>
          </div>
        </div>
