<div class="row bg-title">
		  ...
		  <div class="row">
				...
				<button  onclick="showAjaxModal('<?php echo base_url()."supplier/produk/tambah_varian/".$rows['id_produk']; ?>');"  class='btn btn-sm btn-success' title="Tambah Varian Produk" ><i class='fa fa-plus'></i> Tambah Varian</button> <br/><br/>
						  ...
						  foreach ($varians as $row) {
							...
							<tr>
							  ...
							  <td align="center">
								  ...
								  <button  onclick="showAjaxModal('<?= base_url('supplier/produk/edit_varian/'.$rows['id_produk'].'/'.$row['id_produkvarian']) ?>');"  class='btn btn-sm btn-warning' title="Edit Varian" ><i class='fa fa-pencil'></i></button> 
...
<script>
  function confirmation(ev) {
    ...
    Swal.fire({
      ...
      if (result.value) {
        $.ajax({
          url: site_url + 'supplier/produk/delete_varian/' + data_id,
          type: "POST",
          dataType: "JSON",
