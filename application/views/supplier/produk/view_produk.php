 ...
 <div class="row bg-title">
		  ...
		  <div class="row">
                    <div class="col-md-12 col-lg-12 col-sm-12">
                        <div class="white-box">
			 <?php
			$log = $this->model_supplier->supplier_edit($this->session->idsupplier)->row_array();		
		...
		<?php  $this->session->unset_userdata('Gagal'); 
              ...
              <a class=' btn btn-success btn-sm' href='<?= base_url('supplier/produk/tambah_produk'); ?>'><i class='fa fa-plus'></i> Tambah Produk</a><br/><br/>
                ...
                <tbody>
                  ...
                  foreach ($record as $row) {
					...
					echo $all. " </td>
                              ...
                              <td align='center'>
                                <a class='btn btn-success btn-sm' title='Kelola Varian' href='" . base_url() . "supplier/produk/kelola_varian/$row[id_produk]'><i class='fa fa-list'></i></a>
								
								<a class='btn btn-success btn-sm' title='Ubah' href='" . base_url() . "supplier/produk/edit_produk/$row[id_produk]'><i class='fa fa-pencil'></i></a>
...
<script>
  function confirmation(ev) {
    ...
    Swal.fire({
      ...
      if (result.value) {
        $.ajax({
          url: site_url + 'supplier/produk/delete_produk/' + data_id,
          type: "POST",
          dataType: "JSON",
