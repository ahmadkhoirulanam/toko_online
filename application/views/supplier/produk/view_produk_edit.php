<div class="row bg-title">
		  ...
		  <div class="row">
              ...
              <form action="<?= base_url('supplier/produk/edit_produk') ?>" method="post" enctype="multipart/form-data">
			...
			<input type="file" class="" id="" name="gambar4">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-8">
                    ...
                    <a href='<?= base_url('supplier/produk') ?>'><button type='button' class='btn btn-secondary btn-sm'>Batal</button></a>
                  </div>
                </div>
