<div class="row bg-title">
		  ...
		  <div class="row">
            ...
            <form action="<?= base_url('supplier/produk/tambah_produk') ?>" method="post" class="form-horizontal" enctype="multipart/form-data">
		 ...
		 <div class="form-group row">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-8">
                    ...
                    <a href='<?= base_url('supplier/produk') ?>'><button type='button' class='btn btn-secondary sm'>Batal</button></a>
                  </div>
                </div>
