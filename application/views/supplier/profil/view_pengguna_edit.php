 ...
 <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title"> Profil Perusahaan</h4> </div>
		  ...
		  <div class="row">
				...
				<h3 class="box-title m-b-0">Edit Profil Perusahaan</h3><br/>
				
				
            <form action="<?= base_url('supplier/profil') ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
